...
const Page = () => {
  ...
  const handleModalStateChange = (
    modal: keyof typeof initialModalStates,
    state: boolean,
  ) => {
  ...
  return (
    <>
      ...
      <ParentPashboardLayout>
        <div className="w-full h-full space-y-6 overflow-y-auto bg-[#F6F8FA]">
          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-5">
            <div className="bg-white rounded-2xl p-5 space-y-4">
              ...
              <div className="w-full bg-[#F6F8FA] p-2 grid grid-cols-1 lg:grid-cols-2 gap-2"></div>
            </div>
            <div className="bg-white rounded-2xl p-5 space-y-4">
              <div className="w-full flex items-center justify-between">
              ...
              <div className="w-full space-y-8 rounded-2xl bg-white">
                    ...
                    <div className="w-full space-y-2">
                      ...
                      <div className="w-full space-y-1">
                        ...
                        <p className="text-sm text-neutral-100">
                          Your points equals {formatCurrency(0)}
                        </p>
                      </div>
                      <WithdrawPoints
                        onOpenChange={(withdraw) =>
                          handleModalStateChange("withdraw", withdraw)
                        }
                  ...
                  <div className="w-full rounded-lg bg-gradient-to-r from-[#feede3]/40 to-[#6f42c1]/15 p-4">
                    <div className="space-y-8 py-1">
                      ...
                      <div className="flex items-center gap-x-2">
                        <Sharer
                          onClose={(share) =>
                            handleModalStateChange("share", share)
                          }
                          open={modalStates.share}
                          url={
                            `https://classore.com/signup?step=1&referral_code=${""}` ||
                            ""
                          }
                        />
                        <button
                ...
                <div className="w-full space-y-4">
                  ...
                  <div className="w-full space-y-4 min-h-[300px]"></div>
                </div>
              </div>
            </div>
          </div>
