...
const Page = () => {
  ...
  const examBundles = (index: number) => {
    return bundles?.data.filter(
      (bundle) =>
        bundle.examinationbundle_examination ===
        form.wards?.at(index)?.examination,
    );
  };
    ...
    (index: number) => {
      return (
        subjects
          ?.filter(
            (subject) =>
              subject.subject_examination_bundle ===
              form.wards?.at(index)?.examination_bundle,
          )
          .map((subject) => ({
