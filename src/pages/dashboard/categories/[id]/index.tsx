  ...
  return (
    <>
      <Seo
        title={
          bundle?.name
            ? `${capitalize(bundle?.name)} Exam Prep Bundle`
            : "Bundle Details"
        }
      />
                  ...
                  {bundle?.is_bought ? (
                    <p
                      className={`rounded-full ${
                        PLAN_STATUS[
                          currentBundle?.status as keyof typeof PLAN_STATUS
                        ].color
                      } px-4 py-1.5 text-sm`}
                    >
                      {
                ...
                <div className="flex flex-col gap-2 pt-4">
                  ...
                  <ul className="flex flex-col gap-4 rounded-xl bg-neutral-100 p-4">
                    ...
                    <li className="flex items-center gap-2 text-sm text-neutral-400">
                      ...
                      <span>
                        {bundle?.number_of_subjects} Subjects from all
                        departments{" "}
                      </span>
                    </li>
                    <li className="flex items-center gap-2 text-sm text-neutral-400">
                      ...
                      <span>
                        {bundle?.average_downloadable_materials} Downloadable
                        Material Per Subject{" "}
                      </span>
                    </li>
                    <li className="flex items-center gap-2 text-sm text-neutral-400">
      ...
      {currentBundle && (
        <RenewalModal open={open} setOpen={setOpen} bundle={currentBundle} />
      )}
    </>
  );
};
