	...
	return (
		<>
			...
			<main className='scrollbar w-full font-geist'>
				<section className='relative lg:min-h-dvh w-full overflow-y-hidden bg-gradient-to-b from-primary-100 to-neutral-100'>
					...
					<div className='container px-3 lg:px-0 my-32 lg:absolute lg:left-1/2 lg:top-10 lg:!z-[1] flex h-full lg:-translate-x-1/2 flex-col items-center justify-end gap-y-5'>
						<div className='flex flex-col items-center  gap-y-4 text-center lg:w-[750px]'>
							...
							<div className='flex flex-col gap-3 overflow-hidden'>
								<h1 className='animate-slide-from-top font-semibold text-pretty text-3xl text-primary-900 lg:text-[56px] lg:leading-[100%]'>
								...
								<p className='mx-auto max-w-lg animate-slide-from-bottom text-neutral-500 lg:text-lg'>
									Our platform simulate local and international exams. Prepare in
									real time. Pass with confidence
								</p>
							</div>
							<div className='flex flex-col w-72 md:w-fit md:flex-row md:items-center md:justify-center gap-4 pt-4'>
								<Button
									asChild
									variant='outline-primary'
									className='rounded-lg border-secondary-300 w-full text-secondary-300 hover:bg-secondary-50 px-8'>
						...
						<div className='relative hidden lg:flex w-full lg:h-[650px]'>
				...
				<section className='w-full bg-neutral-100 lg:py-20' id='what-we-offer'>
					<div className='container flex flex-col items-center gap-y-20'>
						<div className='flex max-w-[650px] flex-col items-center gap-y-4 text-center'>
							<p className='text-xs font-medium text-secondary-400 lg:text-sm'>
								WHAT WE OFFER
							</p>
							<h4 className='text-2xl font-medium lg:text-4xl'>
								<span className='text-neutral-400'>A Personalize Learning for</span>{' '}
								Students,
				...
				<section className='w-full bg-primary-100 py-10 lg:py-20'>
					<div className='container space-y-20 px-4 lg:px-0'>
						{INCENTIVES.map(
							({ button, description, href, image, label, title }, index) => (
								<div
									key={index}
				...
				<section className='w-full bg-primary-100 pt-10 lg:pt-20'>
					<div className='container px-3 lg:px-0 flex flex-col items-center gap-y-14 md:gap-y-20 overflow-hidden'>
						<div className='flex max-w-[450px] flex-col items-center gap-y-4 text-center'>
							...
							<p className='text-xs text-neutral-400 lg:text-sm'>
								Earn commissions for successful referrals, track your performance
								with detailed analytics and start earning quickly with easy
								registration
							</p>
				...
				<section
					className='w-full bg-neutral-100 py-10 lg:py-20'
				...
				<section className='w-full bg-primary-100'>
					<div className='container flex flex-col gap-8 md:grid md:grid-cols-2'>
						<div className='flex flex-1 flex-col items-start justify-center px-4 py-10 lg:py-0 lg:px-0'>
							<div className='space-y-4 lg:w-[450px]'>
								<p className='text-xs font-medium text-secondary-400 lg:text-sm'>
									MOBILE APP
								</p>
								...
								<p className='text-xs text-neutral-400 lg:text-sm'>
									Earn commissions for successful referrals, track your
									performance with detailed analytics and start earning quickly
