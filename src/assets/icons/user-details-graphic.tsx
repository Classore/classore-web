...
export const UserDetailsGraphic = (props: SVGProps<SVGSVGElement>) => (
	<svg xmlns="http://www.w3.org/2000/svg" width={76} height={76} fill="none" {...props}>
					...
					<g clipPath="url(#f)">
						...
						<g filter="url(#g)">
							...
							<path
								...
								strokeWidth={2}
								d="M46 45c0-1.396 0-2.093-.172-2.661a4 4 0 0 0-2.667-2.667c-.568-.172-1.265-.172-2.661-.172h-5c-1.396 0-2.093 0-2.661.172a4 4 0 0 0-2.667 2.667C30 42.907 30 43.604 30 45m12.5-13.5a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0Z"
							/>
						</g>
					</g>
					<rect
		...
		<defs>
			<filter
				...
				<feBlend in2="BackgroundImageFix" result="effect1_dropShadow_326_56849" />
				<feBlend in="SourceGraphic" in2="effect1_dropShadow_326_56849" result="shape" />
			</filter>
			<filter
				id="e"
				width={44}
