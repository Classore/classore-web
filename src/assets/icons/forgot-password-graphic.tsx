...
export const ForgotPasswordGraphic = (props: SVGProps<SVGSVGElement>) => (
	<svg xmlns="http://www.w3.org/2000/svg" width={76} height={76} fill="none" {...props}>
			...
			<g clipPath="url(#b)">
				...
				<g filter="url(#e)">
					...
					<path
						...
						strokeWidth={2}
						d="M38 36h.005M43 36h.005M33 36h.005M31.2 31h13.6c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C48 32.52 48 33.08 48 34.2v3.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C46.48 41 45.92 41 44.8 41H31.2c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C28 39.48 28 38.92 28 37.8v-3.6c0-1.12 0-1.68.218-2.108a2 2 0 0 1 .874-.874C29.52 31 30.08 31 31.2 31Zm7.05 5a.25.25 0 1 1-.5 0 .25.25 0 0 1 .5 0Zm5 0a.25.25 0 1 1-.5 0 .25.25 0 0 1 .5 0Zm-10 0a.25.25 0 1 1-.5 0 .25.25 0 0 1 .5 0Z"
					/>
				</g>
			</g>
			<rect
		...
		<defs>
			<filter
				...
				<feBlend in2="BackgroundImageFix" result="effect1_dropShadow_326_58684" />
				<feBlend in="SourceGraphic" in2="effect1_dropShadow_326_58684" result="shape" />
			</filter>
			<filter
				id="e"
				width={44}
