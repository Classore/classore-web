...
export const SuccessGraphic = (props: SVGProps<SVGSVGElement>) => (
	<svg xmlns="http://www.w3.org/2000/svg" width={76} height={76} fill="none" {...props}>
			...
			<g clipPath="url(#b)">
				...
				<g filter="url(#e)">
					...
					<path
						...
						strokeWidth={2}
						d="M48 34.586v.92a10 10 0 1 1-5.93-9.14M48 27.5 38 37.51l-3-3"
					/>
				</g>
			</g>
			<rect
		...
		<defs>
			<filter
				...
				<feBlend in2="BackgroundImageFix" result="effect1_dropShadow_326_59277" />
				<feBlend in="SourceGraphic" in2="effect1_dropShadow_326_59277" result="shape" />
			</filter>
			<filter
				id="e"
				width={44}
