	...
	return (
		<nav className="flex w-full items-center justify-between border-b border-b-neutral-200 bg-white/75 px-3 py-4 backdrop-blur-sm">
			<div className="flex w-1/2 items-center gap-x-2">
				<Image src={classoreai} alt="classore" width="36" height="36" />
				<h1 className="text-lg font-medium -tracking-[0.03em] text-neutral-900 md:text-2xl">
					My AI Tutor
				</h1>
			</div>
