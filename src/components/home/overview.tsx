  ...
  return (
    <div className="relative flex aspect-[1.81/1] w-full flex-col justify-between overflow-hidden rounded-2xl border bg-[#e2e4e9] p-5">
      ...
      <div className="flex w-full flex-col gap-3">
        ...
        <p className="text-sm">
          You haven&apos;t started your learning yet. Let&apos;s get started
          with {exam_type} this morning
        </p>
      </div>
  ...
  return (
    <div className="relative flex aspect-[1.81/1] w-full flex-col gap-6 overflow-hidden rounded-2xl border bg-[#e2e4e9] p-5">
      ...
      <div className="flex w-full flex-col">
        ...
        <Link
          href="/dashboard"
          className="ml-6 text-sm text-secondary-400 underline"
        >
  ...
  return (
    <div className="relative flex aspect-[1.81/1] w-full flex-col justify-between overflow-hidden rounded-2xl border bg-[#e2e4e9] p-5">
      ...
      <div className="flex w-full flex-col gap-3">
        ...
        <p className="text-sm">
          Complete Quizzes with high accuracy to rank higher and earn point
          rewards
        </p>
      </div>
