...
>(({ className, children, ...props }, ref) => (
	<SelectPrimitive.Item
		...
		<span className="absolute right-4 ml-auto flex size-5 items-center justify-center rounded-full border-2 transition-all group-hover:border-primary-300 group-focus-visible:border-primary-300 group-data-[state=checked]:border-primary-300">
