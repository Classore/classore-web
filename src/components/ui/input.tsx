...
const Input = <T extends FieldValues>({
	...
	return (
		<div className={cn("flex flex-col gap-1.5 font-body", className)}>
			<label id={name} className={cn("text-sm text-neutral-400 dark:text-neutral-50", labelClassName)}>
				{label}
			</label>
