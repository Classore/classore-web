...
const buttonVariants = cva(
	"flex w-full items-center justify-center gap-2 whitespace-nowrap rounded-md text-base transition-all focus-visible:outline-offset-2 focus-visible:outline focus-visible:outline-1 focus-visible:outline-primary-300 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:ring-offset-neutral-950 font-body shadow-[0px_1px_2px_rgba(0,0,0,0.08)] dark:focus-visible:ring-neutral-300 active:scale-[.99]",
	{
		variants: {
			variant: {
				default: "bg-primary-300 text-neutral-50 hover:bg-primary-400",
				inverse: "text-primary-300 bg-[#f1ecf9] hover:bg-[#f1ecf9]/80 font-light",
				primary: "bg-white text-secondary-400 hover:bg-neutral-100 hover:text-secondary-500",
				secondary: "bg-secondary-200 text-secondary-500 hover:bg-secondary-200/80",
				destructive: "bg-red-500 text-neutral-50 hover:bg-red-500/90",
				outline: "border border-neutral-300 bg-white hover:bg-neutral-100 text-primary-400",
