					...
					<>
						{slots.map((slot, index) => (
							<div
								...
								className="relative flex size-[60px] flex-1 items-center justify-center rounded-lg bg-[rgba(241,236,249,0.5)] text-base font-medium text-primary-300 transition-all data-[active=true]:z-10 data-[invalid=true]:border-[1.3px] data-[invalid=true]:border-red-600 data-[invalid=true]:bg-red-50/50 data-[active=true]:shadow-primary data-[active=true]:ring-1 data-[active=true]:ring-primary-300">
