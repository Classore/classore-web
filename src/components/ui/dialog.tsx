...
const dialogVariants = cva(
	"fixed left-1/2 max-h-[96%] w-[95vw] max-w-[400px] overflow-y-hidden top-1/2 overflow-y-auto overflow-x-hidden z-50 translate-x-[-50%] translate-y-[-50%] gap-4 border border-neutral-200 p-4 md:p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] dark:border-neutral-800 dark:bg-neutral-950 rounded-2xl bg-white",
	{
		variants: {
			variant: {
