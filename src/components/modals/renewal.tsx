			...
			<DialogContent className="flex w-96 flex-col gap-6">
				...
				<ul className="flex flex-col gap-4">
					...
					<li>
						...
						<p className="font-medium capitalize">{bundle.exam_bundle_details.name} Prep Bundle</p>
					</li>
					<li>
				...
				<div className="flex flex-col gap-1">
					<Button onClick={() => mutate()} type="submit" disabled={isPending}>
						{isPending ? <Spinner /> : `Renew for ${formatCurrency(Number(bundle.renewal_amount ?? 0))}`}
					</Button>
