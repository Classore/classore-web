      ...
      <DialogContent className="flex w-[400px] flex-col gap-4">
        ...
        {unansweredCount > 0 ? (
          <p className="flex w-full flex-col gap-4 rounded-lg bg-neutral-100 p-4 text-sm text-neutral-400 transition-all duration-700">
            You have {unansweredCount} question${unansweredCount > 1 ? "s" : ""}{" "}
            unanswered. Are you sure you want to submit now?
          </p>
        ) : (
          <p className="flex w-full flex-col gap-4 rounded-lg bg-neutral-100 p-4 text-sm text-neutral-400 transition-all duration-700">
            Are you sure you want to submit your quiz now? You will not be able
