...
export const EXAMS = [
  { label: "cibn", image: "/assets/logos/cibn.png" },
  { label: "gmat", image: "/assets/logos/gmat.png" },
  { label: "gre", image: "/assets/logos/gre.png" },
  { label: "ib", image: "/assets/logos/ib.png" },
  { label: "ican", image: "/assets/logos/ican.png" },
  { label: "ielts", image: "/assets/logos/ielts.png" },
  { label: "igsce", image: "/assets/logos/igsce.png" },
  { label: "ijmb", image: "/assets/logos/ijmb.png" },
  { label: "jamb", image: "/assets/logos/jamb.png" },
  { label: "jupeb", image: "/assets/logos/jupeb.png" },
  { label: "lsac", image: "/assets/logos/lsac.png" },
  { label: "mdcn", image: "/assets/logos/mdcn.png" },
  { label: "nabteb", image: "/assets/logos/nabteb.png" },
  { label: "neco", image: "/assets/logos/neco.png" },
  { label: "pmi", image: "/assets/logos/pmi.png" },
  { label: "sat", image: "/assets/logos/sat.png" },
  { label: "toefl", image: "/assets/logos/toefl.png" },
  { label: "waec", image: "/assets/logos/waec.png" },
];
...
export const PERSONALIZED_PLANS: PersonalizedPlanProps[] = [
  {
    ...
    description:
      "Discover a variety of topics across different categories and levels.",
  ...
  },
  {
    ...
    description:
      "Track your growth with detailed analytics and visual performance charts.",
  ...
  },
  {
    ...
    description:
      "Connect, discuss, and learn with peers through interactive forums.",
...
export const TESTIMONIALS: SingleBundleResp["reviews"][number][] = [
  ...
  },
  {
    ...
    user_profile_image:
      "https://robohash.org/vellaborumdistinctio.png?size=50x50&set=set1",
  },
  {
    rating_comment:
    ...
    user_profile_image:
      "https://robohash.org/quiquiatempora.png?size=50x50&set=set1",
  },
  {
    rating_comment:
    ...
    user_profile_image:
      "https://robohash.org/idipsamut.png?size=50x50&set=set1",
  },
  {
    rating_comment:
      "Phasellus sit amet erat. Nulla tempus. Vivamus in felis eu sapien cursus vestibulum.",
    ...
    user_profile_image:
      "https://robohash.org/evenietetexpedita.png?size=50x50&set=set1",
  },
  {
    rating_comment:
    ...
    user_profile_image:
      "https://robohash.org/delenitiiureullam.png?size=50x50&set=set1",
  },
  {
    rating_comment:
    ...
    user_profile_image:
      "https://robohash.org/autnisiporro.png?size=50x50&set=set1",
  },
  {
    rating_comment:
    ...
    user_profile_image:
      "https://robohash.org/quibusdamnequeest.png?size=50x50&set=set1",
  },
  {
    rating_comment:
    ...
    user_profile_image:
      "https://robohash.org/estquosint.png?size=50x50&set=set1",
  },
  {
    rating_comment:
    ...
    user_profile_image:
      "https://robohash.org/blanditiisducimussed.png?size=50x50&set=set1",
  },
  {
    rating_comment:
  ...
  },
  {
    ...
    user_profile_image:
      "https://robohash.org/quiaddeserunt.png?size=50x50&set=set1",
  },
  {
    rating_comment:
    ...
    user_profile_image:
      "https://robohash.org/estautculpa.png?size=50x50&set=set1",
  },
  {
    rating_comment:
    ...
    user_profile_image:
      "https://robohash.org/quihicfacere.png?size=50x50&set=set1",
  },
  {
    rating_comment:
    ...
    user_last_name: "Lane",
    user_profile_image:
      "https://robohash.org/solutaquialiquid.png?size=50x50&set=set1",
  },
];
